...
<template>
    <div class="rounded-[12px] border border-[#e5e7eb] bg-white p-5">
        <h2 class="text-[14px] font-[600] text-[#111111]">Public sharing</h2>
        <p class="mt-1 text-[13px] text-[#6b7280]">Anyone with the link can view public content without signing in.</p>
        ...
        <div
            ...
            class="mt-4 rounded-[8px] border border-[#d1fae5] bg-[#ecfdf5] p-4"
        >
        ...
        <p v-else-if="isPublic" class="mt-4 text-[13px] text-[#898989]">
