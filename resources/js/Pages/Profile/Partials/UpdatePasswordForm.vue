    ...
    <section>
        <header class="flex flex-wrap items-start justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <PrimaryButton type="submit" form="profile-password-form" :disabled="form.processing">Save</PrimaryButton>
            </div>
        </header>

        <form id="profile-password-form" @submit.prevent="updatePassword" class="mt-6 space-y-5">
            <div>
